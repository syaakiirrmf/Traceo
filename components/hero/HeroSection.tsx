...
function FeatureRow({ num, title, desc, delay = 0 }: { num: string; title: string; desc: string; delay?: number }) {
  return (
    <div
      ...
      onMouseEnter={(e) => { e.currentTarget.style.background = C.bgAlt2 }}
      onMouseLeave={(e) => { e.currentTarget.style.background = 'transparent' }}
    >
      <span style={{ fontFamily: "'DM Sans', system-ui", fontSize: 12, fontWeight: 600, color: C.brand, letterSpacing: '0.06em', minWidth: 32, paddingTop: 4 }}>
        {num}
      </span>
      <div>
        <h3 style={{ fontSize: 18, fontWeight: 700, color: C.text, marginBottom: 6, letterSpacing: '-0.02em', fontFamily: "'Fustat', system-ui" }}>{title}</h3>
...
function ContactRow({ icon, title, value, href }: { icon: React.ReactNode; title: string; value: string; href: string }) {
  return (
    ...
    >
      <div style={{ width: 40, height: 40, borderRadius: 12, background: C.bgAlt, border: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: C.textSub, flexShrink: 0, transition: 'background 0.2s, color 0.2s' }}
        className="group-hover:bg-blue-50 group-hover:!text-blue-500"
      >
        {icon}
      </div>
      <div>
        <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: C.textMuted, marginBottom: 2 }}>{title}</div>
        <div style={{ fontSize: 15, fontWeight: 600 }}>{value}</div>
      </div>
      <ArrowUpRight size={16} className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity" style={{ color: C.brand }} />
    </a>
  )
}
...
export default function HeroSection() {
  ...
  return (
    <div id="top" style={{ background: C.bg, color: C.text, fontFamily: DM }}>
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <div className="sticky top-0 z-50 flex justify-center w-full pointer-events-none px-4" style={{ paddingTop: 20 }}>
        <nav
        ...
        >
          {/* Logo */}
          <a href="#top" className="flex items-center gap-2 mr-2 select-none" style={{ textDecoration: 'none' }}>
            <div style={{ width: 28, height: 28, borderRadius: 8, background: C.brand, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                ...
                <path d="M7 4.5v5M4.5 6L7 7.5 9.5 6" stroke="rgba(255,255,255,0.4)" strokeWidth="1.2" strokeLinecap="round" />
              </svg>
            </div>
            <span style={{ fontSize: 14, fontWeight: 700, color: C.text, letterSpacing: '-0.02em', fontFamily: FU }}>Traceo</span>
          </a>
          ...
          <div className="hidden md:flex items-center">
            {[
              ...
              <a
                key={link.label}
                href={link.href}
                style={{ display: 'block', padding: '5px 11px', borderRadius: 10, fontSize: 13, fontWeight: 500, color: C.textSub, textDecoration: 'none', transition: 'background 0.15s, color 0.15s' }}
          ...
          <Link
            ...
            style={{
              ...
              height: 34, padding: '0 14px', marginLeft: 4,
              borderRadius: 12,
              background: C.brand,
              color: '#fff', fontSize: 13, fontWeight: 600, textDecoration: 'none',
              boxShadow: 'inset 0px 2px 3px 0px rgba(255,255,255,0.22), 0 2px 8px rgba(0,102,255,0.3)',
      ...
      <ViewTransition enter="hero-enter" default="none">
        <section className="relative" style={{ marginTop: -60, minHeight: '100dvh' }}>
          <div className="grid grid-cols-1 lg:grid-cols-2" style={{ minHeight: '100dvh' }}>
            ...
            <div className="relative flex flex-col justify-center" style={{ background: C.bg, paddingTop: 'clamp(100px, 18vh, 160px)', paddingBottom: 80, paddingLeft: 'clamp(24px, 6vw, 80px)', paddingRight: 'clamp(24px, 4vw, 60px)', zIndex: 2 }}>

              {/* Background glow — top left blue */}
              <div className="pointer-events-none absolute" aria-hidden style={{
                top: 0, left: 0, width: 520, height: 480,
                background: 'radial-gradient(ellipse at 20% 20%, rgba(0,102,255,0.10) 0%, rgba(96,177,255,0.06) 40%, transparent 70%)',
                filter: 'blur(48px)',
              }} />
              <div className="pointer-events-none absolute" aria-hidden style={{
                bottom: '10%', right: '-10%', width: 360, height: 320,
              ...
              <p
                style={{
                  ...
                  transition: 'opacity 0.7s 0.26s ease, transform 0.7s 0.26s cubic-bezier(0.16,1,0.3,1)',
                }}
              >
                Log monitoring visits, check arrear status, and export Word reports for all three JV categories.
              </p>
              ...
              <div
                style={{
                  ...
                  transition: 'opacity 0.7s 0.38s ease, transform 0.7s 0.38s cubic-bezier(0.16,1,0.3,1)',
                }}
              >
                <Link
                  href="/login"
                  ...
                  style={{
                    ...
                    boxShadow: 'inset 0px 4px 4px 0px rgba(255,255,255,0.22), 0 6px 24px rgba(0,102,255,0.3)',
                    transition: 'transform 0.2s, box-shadow 0.2s',
                    fontFamily: FU,
                  }}
                ...
                <a
                  ...
                  style={{
                    ...
                    color: C.textSub, fontSize: 14, fontWeight: 600, textDecoration: 'none',
              ...
              >
                {['Role-based access', 'Word & PDF export', 'JV1 · JV2 · JV3'].map((item) => (
                  <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: 11, fontWeight: 600, color: C.textMuted }}>
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0" aria-hidden>
                <div style={{ position: 'absolute', top: '10%', left: '5%', width: 500, height: 500, background: 'radial-gradient(ellipse, rgba(0,102,255,0.09) 0%, rgba(96,140,255,0.04) 40%, transparent 70%)', filter: 'blur(64px)' }} />
                <div style={{ position: 'absolute', bottom: '15%', right: '0%', width: 350, height: 320, background: 'radial-gradient(ellipse, rgba(100,60,255,0.07) 0%, transparent 65%)', filter: 'blur(52px)' }} />
              </div>
          ...
          <div className="hidden lg:block absolute top-0 bottom-0" style={{ left: '50%', width: 1, background: `linear-gradient(180deg, transparent 0%, ${C.border} 30%, ${C.border} 70%, transparent 100%)`, zIndex: 3 }} />
        </section>
      </ViewTransition>
      ...
      <section style={{ background: C.bg, borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}` }}>
        <div className="max-w-6xl mx-auto px-6 py-8 flex flex-wrap items-center justify-between gap-6">
          <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.14em', textTransform: 'uppercase', color: C.textMuted, flexShrink: 0 }}>
            Powered by
          </span>
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <section id="facilities" className="scroll-mt-20" style={{ background: C.bgAlt2, borderBottom: `1px solid ${C.border}` }}>
        <div className="max-w-6xl mx-auto px-6 md:px-10 py-20 md:py-28">
          {/* Header — no eyebrow (restrained) */}
          <div className="max-w-xl mb-16">
            <h2
              data-animate style={{ ...s(0), fontFamily: FU }}
            ...
            <p data-animate style={{ ...s(80), color: C.textSub, fontSize: 16, lineHeight: 1.65, maxWidth: 420 }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {/* Large card — JV1 */}
            <div
              data-animate style={{ ...s(0), background: C.dark, minHeight: 320, border: `1px solid rgba(255,255,255,0.06)` }}
              className="lg:col-span-2 rounded-2xl overflow-hidden relative flex flex-col justify-end group"
            >
              <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at 70% 30%, rgba(0,102,255,0.3) 0%, transparent 60%)', pointerEvents: 'none' }} />
              <div style={{ position: 'absolute', top: 28, right: 28, fontSize: 10, fontWeight: 700, letterSpacing: '0.1em', color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase' }}>JV Syarikat</div>
              {/* Abstract bar chart decoration */}
              <div className="absolute bottom-20 left-8 flex items-end gap-1.5" style={{ pointerEvents: 'none' }}>
                {[35, 60, 42, 88, 55, 72, 48, 90, 65].map((h, i) => (
                  <div key={i} style={{ width: 10, height: h * 1.2, background: i === 7 ? C.brand : `rgba(0,102,255,${0.12 + i * 0.04})`, borderRadius: '4px 4px 0 0', transition: 'height 0.4s' }} />
                ))}
              </div>
              <div style={{ position: 'relative', padding: '0 28px 28px', zIndex: 2 }}>
                <div style={{ fontFamily: FU, fontSize: 28, fontWeight: 900, color: '#fff', lineHeight: 1.1, marginBottom: 6 }}>JV1 · Syarikat</div>
                <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)' }}>Corporate accounts: akaun status, tunggakan, dan susulan.</div>
              </div>
            </div>

            {/* JV2 */}
            <div
              data-animate style={{ ...s(100), background: C.bgAlt, minHeight: 200, border: `1px solid ${C.border}`, padding: 28 }}
              className="rounded-2xl relative overflow-hidden flex flex-col justify-between"
            >
              <div>
                <div style={{ fontSize: 10, fontWeight: 700, color: C.brand, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 12 }}>JV Tanah</div>
                <div style={{ fontFamily: FU, fontSize: 22, fontWeight: 900, color: C.text, lineHeight: 1.1, marginBottom: 8 }}>JV2 · Tanah</div>
                <div style={{ fontSize: 13, color: C.textSub, lineHeight: 1.6 }}>Land financing. Log site visits, track progress, export kronologi.</div>
              </div>
              <div className="flex items-end gap-1 mt-6">
                {[20, 40, 30, 60, 45, 55, 35].map((h, i) => (
                  <div key={i} style={{ flex: 1, height: h, background: i === 5 ? C.brand : `rgba(0,102,255,${0.08 + i * 0.05})`, borderRadius: '3px 3px 0 0' }} />
                ))}
              </div>
            </div>
            ...
            {/* JV3 */}
            <div
              data-animate style={{ ...s(180), background: C.brand, minHeight: 200, padding: 28 }}
              className="rounded-2xl relative overflow-hidden flex flex-col justify-between"
            >
              <div>
                <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.6)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 12 }}>Pinjaman Individu</div>
                <div style={{ fontFamily: FU, fontSize: 22, fontWeight: 900, color: '#fff', lineHeight: 1.1, marginBottom: 8 }}>JV3 · Individu</div>
                <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.65)', lineHeight: 1.6 }}>Individual loans. Log visits, monitor status, generate PDF.</div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 16 }}>
                <div style={{ width: 32, height: 32, borderRadius: '50%', background: 'rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <ArrowUpRight size={14} color="#fff" />
                </div>
                <span style={{ fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.7)' }}>Active accounts: 100+</span>
              </div>
            </div>

            {/* Stats card */}
            <div
              data-animate style={{ ...s(240), background: C.bgAlt, minHeight: 160, padding: '28px 36px', border: `1px solid ${C.border}` }}
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={stat.v}>
                    <div style={{ fontFamily: FU, fontSize: 28, fontWeight: 900, color: C.text, lineHeight: 1 }}>{stat.v}</div>
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <section id="about" className="scroll-mt-20" style={{ background: C.bg, borderBottom: `1px solid ${C.border}` }}>
        <div className="max-w-6xl mx-auto px-6 md:px-10 py-20 md:py-28">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p data-animate style={{ ...s(80), color: C.textSub, fontSize: 16, lineHeight: 1.7, marginBottom: 24, maxWidth: 440 }}>
                Log monitoring visits, attach photos, check account status, and export Word reports. No file switching.
              </p>
              ...
              <div data-animate style={s(160)} className="space-y-3">
                {[
                  ...
                  <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 14, color: C.textSub }}>
                    <div style={{ width: 20, height: 20, borderRadius: '50%', background: C.brandSubtle, border: `1px solid rgba(0,102,255,0.2)`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              ...
              <div data-animate style={{ ...s(240), marginTop: 36 }}>
                <Link
                  ...
                  style={{
                    ...
                    fontSize: 14, fontWeight: 600, color: C.brand, textDecoration: 'none',
                  }}
                >
            ...
            <div
              data-animate style={{ ...s(120), border: `1px solid ${C.border}`, boxShadow: `0 24px 80px rgba(0,0,0,0.08)` }}
            ...
            >
              ...
              <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 80, background: 'linear-gradient(transparent, rgba(255,255,255,0.6))' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      ═══════════════════════════════════════════════════════════════ */}
      <section id="features" className="scroll-mt-20" style={{ background: C.bgAlt2, borderBottom: `1px solid ${C.border}` }}>
        <div className="max-w-6xl mx-auto px-6 md:px-10 py-20 md:py-28">
          <div className="grid lg:grid-cols-[340px_1fr] gap-16">
            ...
            <div className="lg:sticky" style={{ top: 100, alignSelf: 'start' }}>
              ...
              <p data-animate style={{ ...s(80), color: C.textSub, fontSize: 15, lineHeight: 1.7, marginBottom: 28 }}>
                Five core functions. Nothing more.
              </p>
              <div data-animate style={s(160)}>
                <Link
                  href="/login"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 8, height: 44, padding: '0 20px', borderRadius: 12, background: C.brand, color: '#fff', fontSize: 13, fontWeight: 600, textDecoration: 'none', fontFamily: FU }}
                >
      ...
      {/* ═══════════════════════════════════════════════════════════════
          CONTACT
      ═══════════════════════════════════════════════════════════════ */}
      <section id="contact" className="scroll-mt-20" style={{ background: C.bg, borderBottom: `1px solid ${C.border}` }}>
        <div className="max-w-6xl mx-auto px-6 md:px-10 py-20 md:py-28">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p data-animate style={{ ...s(80), color: C.textSub, fontSize: 15, lineHeight: 1.7 }}>
                Drop us a message for account access, technical issues, or anything else. We'll get back to you.
              </p>
            </div>
            ...
            <div data-animate style={s(120)}>
              <ContactRow
                icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><rect x="2" y="4" width="20" height="16" rx="3" stroke="currentColor" strokeWidth="1.8"/><path d="M2 8l10 6 10-6" stroke="currentColor" strokeWidth="1.8"/></svg>}
              ...
              />
              <ContactRow
                icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>}
              ...
              {/* SLA info */}
              <div style={{ marginTop: 24, padding: '16px 20px', borderRadius: 14, background: C.bgAlt, border: `1px solid ${C.border}`, display: 'flex', gap: 12, alignItems: 'center' }}>
                <div style={{ width: 8, height: 8, borderRadius: '50%', background: '#22c55e', flexShrink: 0 }} />
                <div>
                  <div style={{ fontSize: 13, fontWeight: 600, color: C.text }}>Office Hours Support</div>
          ...
          <div className="p-8 md:p-10 lg:p-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 md:gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p
                  ...
                  style={{ fontFamily: DM }}
                >
                  Facility monitoring for JV Syarikat, Tanah, and Pinjaman Individu. Log visits, track accounts, export reports.
                </p>
              </div>
            ...
            {cols.map((col) => (
              <div key={col.header} className="space-y-6">
                <h4
                  className="text-[14px] font-medium text-[#94A3B8]"
                  style={{ fontFamily: DM }}
                >
                  {col.header}
                </h4>
