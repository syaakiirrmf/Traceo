...
export const metadata: Metadata = { title: 'JV Tanah — Tanah Usahasama' }
...
export default async function SummaryJV2Page() {
  ...
  const { data: fasiliti } = await supabase
    .from('fasiliti')
    .select('id, kod_rujukan, pembiaya_modal, nama_peminjam, jumlah_pembiayaan, perkongsian_keuntungan, tunggakan_dividen, bayaran_tambahan, jumlah_tunggakan_semasa, ringkasan_cagaran, penama_aset, status_pindahmilik, status_fasiliti, harga_jualan, catatan_am, dikemaskini_pada')
